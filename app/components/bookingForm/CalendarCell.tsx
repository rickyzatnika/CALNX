  ...
  return (
    ...
    >
      ...
      >
        <div
          className={cn(
            "size-full cursor-pointer rounded-sm flex items-center justify-center text-sm font-semibold",

            finallyIsDisabled ? "text-muted cursor-not-allowed" : "",

            isSelected ? "bg-primary text-muted" : "",
